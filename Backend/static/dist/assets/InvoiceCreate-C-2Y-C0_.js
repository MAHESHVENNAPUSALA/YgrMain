import{d as e,f as t,n,o as r,u as i}from"./index-OYoV3RNy.js";var a=t(i(),1),o=e(),s=()=>{let{showToast:e}=n(),[t,i]=(0,a.useState)([]),[s,c]=(0,a.useState)([]),[l,u]=(0,a.useState)(!0),[d,f]=(0,a.useState)(``),[p,m]=(0,a.useState)(``),[h,g]=(0,a.useState)(`Pending`),[_,v]=(0,a.useState)(``),[y,b]=(0,a.useState)(``),[x,S]=(0,a.useState)(`0`),[C,w]=(0,a.useState)(`18`),[T,E]=(0,a.useState)(``),[D,O]=(0,a.useState)([{service:``,amount:``,discount_percent:`0`}]),[k,A]=(0,a.useState)(!1),j=async()=>{u(!0);try{let e=await r.get(`/api/invoicing-resources/`);i(e.data.clients||[]),c(e.data.services||[])}catch(e){console.error(`Error loading invoicing resources:`,e)}finally{u(!1)}};(0,a.useEffect)(()=>{j()},[]);let M=()=>{O([...D,{service:``,amount:``,discount_percent:`0`}])},N=e=>{let t=[...D];t.splice(e,1),O(t)},P=(e,t,n)=>{let r=[...D];if(r[e][t]=n,t===`service`){let t=s.find(e=>e.id===Number(n));t&&(r[e].amount=t.amount)}O(r)},F=async t=>{if(!d){e(`Please choose a client.`,`warning`);return}let n=D.filter(e=>e.service!==``);if(n.length===0){e(`Please add at least one valid service item.`,`warning`);return}if(t===`preview`){e(`Generating preview calculations. Verify Grand Total in table below.`,`info`);return}A(!0);try{let i={client:d,project:p,discount_percent:x,gst_percent:C,note:T,status:t===`draft`?`Pending`:h,due_date:_||null,paid_date:y||null,items:n};await r.post(`/api/invoices/`,i),e(t===`draft`?`Invoice draft saved successfully.`:`Invoice generated successfully.`,`success`),t===`pdf`&&window.print(),f(``),m(``),g(`Pending`),v(``),b(``),S(`0`),w(`18`),E(``),O([{service:``,amount:``,discount_percent:`0`}])}catch(t){e(t.response?.data?.detail||`Failed to process invoice.`,`error`)}finally{A(!1)}};return(0,o.jsxs)(`div`,{className:`attendance-workspace-container`,style:{padding:`20px`,background:`#f8fafc`,minHeight:`100vh`},children:[(0,o.jsx)(`style`,{children:`
        .premium-card {
          background: #ffffff;
          border-radius: 16px;
