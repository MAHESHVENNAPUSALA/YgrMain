import{a as e,f as t,i as n,m as r,p as i,s as a}from"./index-E7nG5Fmr.js";var o=r(t(),1),s=i();function c(e=``){return e.split(` `).slice(0,2).map(e=>e[0]).join(``).toUpperCase()||`?`}function l(e){if(!e)return``;try{let t=new Date(e),n=new Date,r=new Date(n);return r.setDate(n.getDate()-1),t.toDateString()===n.toDateString()?`Today`:t.toDateString()===r.toDateString()?`Yesterday`:t.toLocaleDateString(`en-IN`,{day:`2-digit`,month:`short`,year:`numeric`})}catch{return``}}function ee(e){if(!e)return``;try{return new Date(e).toDateString()}catch{return``}}var u=[`👍`,`❤️`,`😂`,`😮`,`😢`,`🔥`,`🎉`,`👏`,`💯`,`🙏`];function d({user:e,size:t=36,style:n={}}){let[r,i]=(0,o.useState)(!1),a=e?.name||e?.username||e?.sender_name||``,l=e?.profile_pic||e?.sender_avatar;return l&&!r?(0,s.jsx)(`img`,{src:l,alt:a,onError:()=>i(!0),style:{width:t,height:t,borderRadius:`50%`,objectFit:`cover`,flexShrink:0,...n}}):(0,s.jsx)(`div`,{style:{width:t,height:t,borderRadius:`50%`,background:`linear-gradient(135deg, #3b82f6, #1d4ed8)`,color:`#fff`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontWeight:700,fontSize:t*.38,flexShrink:0,...n},children:c(a)})}function f({status:e}){let t={Online:`#22c55e`,Away:`#f59e0b`,Busy:`#ef4444`,"In Meeting":`#8b5cf6`,"Working From Home":`#06b6d4`,Offline:`#94a3b8`};return(0,s.jsx)(`span`,{style:{display:`inline-block`,width:9,height:9,borderRadius:`50%`,background:t[e]||t.Offline,border:`2px solid #fff`,flexShrink:0},title:e})}var p=()=>{let{user:t}=e(),{showToast:r}=n(),[i,c]=(0,o.useState)([]),[p,m]=(0,o.useState)([]),[te,ne]=(0,o.useState)([]),[h,re]=(0,o.useState)(``),[g,_]=(0,o.useState)(null),[v,ie]=(0,o.useState)(()=>{try{return JSON.parse(localStorage.getItem(`chat_last_read`)||`{}`)}catch{return{}}}),ae=(0,o.useRef)(v),[y,b]=(0,o.useState)([]),[oe,se]=(0,o.useState)(!1),[ce,le]=(0,o.useState)(!0),[x,S]=(0,o.useState)(``),[C,w]=(0,o.useState)(null),[T,E]=(0,o.useState)(null),[D,O]=(0,o.useState)(``),[k,A]=(0,o.useState)(null),[j,M]=(0,o.useState)(null),[ue,de]=(0,o.useState)(!1),[fe,N]=(0,o.useState)(!1),[pe,me]=(0,o.useState)(``),[he,ge]=(0,o.useState)(``),[_e,P]=(0,o.useState)([]),[F,I]=(0,o.useState)(null),[L,ve]=(0,o.useState)([]),[ye,R]=(0,o.useState)(null),[be,xe]=(0,o.useState)(!1),[z,B]=(0,o.useState)(null),Se=(0,o.useRef)(null),V=(0,o.useRef)(null),H=(0,o.useRef)(null),U=(0,o.useRef)(0),Ce=(0,o.useRef)(null),W=(0,o.useRef)(null);(0,o.useEffect)(()=>{ae.current=v,localStorage.setItem(`chat_last_read`,JSON.stringify(v))},[v]);let G=(0,o.useCallback)(async()=>{try{let[e,t]=await Promise.all([a.getAllUsers(),a.getAllChatRooms(ae.current)]),n=e.data||[];c(n);let r=t.data?.channels||[],i=t.data?.teams||[];m(r),ne(i);let o=n.reduce((e,t)=>e+(t.unread||0),0),s=[...r,...i].reduce((e,t)=>e+(t.unread||0),0);window.dispatchEvent(new CustomEvent(`msg-unread-update`,{detail:o+s}))}catch(e){console.error(`Sidebar load error`,e)}finally{le(!1)}},[]),we=async e=>{if(Z){B({type:e,user:Z,status:`Calling...`});try{await a.initiateCall({receiver:Z.id,call_type:e}),setTimeout(()=>{B(e=>e?{...e,status:`Connected`}:null)},2500)}catch(e){r(e.response?.data?.detail||`Failed to initiate call session.`,`error`),B(null)}}};(0,o.useEffect)(()=>{G(),a.updatePresence({status:`Online`}).catch(()=>{});let e=setInterval(()=>G(),1e4);return()=>{clearInterval(e),a.updatePresence({status:`Offline`}).catch(()=>{})}},[G]);let K=(0,o.useCallback)(async(e=!1)=>{if(g){e&&(se(!0),U.current=0);try{let t=e?{}:{last_id:U.current};g.type===`dm`?t.user_id=g.id:t.room_id=g.id;let n=(await a.getChatHistory(t)).data?.messages||[];e?b(n):n.length>0&&b(e=>{let t=new Set(e.map(e=>e.id)),r=n.filter(e=>!t.has(e.id));return r.length?[...e,...r]:e}),n.length>0&&(U.current=n[n.length-1].id)}catch(e){console.error(`Load messages error`,e)}finally{e&&se(!1)}}},[g]);(0,o.useEffect)(()=>{if(g)return K(!0),clearInterval(H.current),H.current=setInterval(()=>K(!1),3e3),()=>clearInterval(H.current)},[g,K]),(0,o.useEffect)(()=>{Se.current?.scrollIntoView({behavior:`smooth`})},[y]),(0,o.useEffect)(()=>{let e=()=>A(null);return window.addEventListener(`click`,e),()=>window.removeEventListener(`click`,e)},[]);let Te=async e=>{e?.preventDefault();let t=x.trim();if(!t&&!V.current?.files[0]||!g)return;let n=new FormData;n.append(`text`,t),g.type===`dm`?n.append(`receiver_id`,g.id):n.append(`room_id`,g.id),C&&n.append(`reply_to_id`,C.id);let i=V.current;i?.files[0]&&(n.append(`file`,i.files[0]),i.value=``),S(``),w(null);try{let e=(await a.sendMessage(n)).data;b(t=>new Set(t.map(e=>e.id)).has(e.id)?t:[...t,e]),U.current=e.id}catch(e){r(e?.response?.data?.detail||`Failed to send message.`,`error`)}},Ee=async()=>{if(!(!T||!D.trim())){try{await a.editMessage({message_id:T.id,is_group:T.is_group,text:D}),b(e=>e.map(e=>e.id===T.id?{...e,text:D,edited:!0}:e))}catch(e){r(e?.response?.data?.detail||`Edit failed.`,`error`)}E(null),O(``)}},q=async(e,t)=>{try{await a.deleteMessage({message_id:e.id,is_group:e.is_group,mode:t}),b(t===`everyone`?t=>t.map(t=>t.id===e.id?{...t,is_deleted:!0,text:``,file_url:null}:t):t=>t.filter(t=>t.id!==e.id))}catch(e){r(e?.response?.data?.detail||`Delete failed.`,`error`)}A(null)},J=async(e,t)=>{try{let n=await a.toggleReaction({message_id:e.id,is_group:e.is_group,emoji:t});b(t=>t.map(t=>t.id===e.id?{...t,reactions:n.data.reactions}:t))}catch(e){console.error(e)}M(null)},De=async()=>{if(!(!F||!L.length)){try{await a.forwardMessage({msg_ids:[F.id],receiver_ids:L}),r(`Message forwarded.`,`success`)}catch{r(`Forward failed.`,`error`)}I(null),ve([])}},Oe=async e=>{e.preventDefault();try{await a.createTeam({name:pe,description:he,users:_e}),N(!1),me(``),ge(``),P([]),G()}catch(e){r(e?.response?.data?.detail||`Failed to create team.`,`error`)}},ke=e=>{S(e.target.value);let t=e.target;t.style.height=`auto`,t.style.height=Math.min(t.scrollHeight,140)+`px`,be||xe(!0),clearTimeout(Ce.current),Ce.current=setTimeout(()=>xe(!1),2e3)},Ae=i.filter(e=>e.name.toLowerCase().includes(h.toLowerCase())||e.role.toLowerCase().includes(h.toLowerCase())),Y=p.filter(e=>e.name.toLowerCase().includes(h.toLowerCase())),X=te.filter(e=>e.name.toLowerCase().includes(h.toLowerCase())),Z=g?.type===`dm`?i.find(e=>e.id===g.id):null,Q=g?.name||``,$=[],je=``;y.forEach(e=>{let t=ee(e.created_at_iso);t&&t!==je&&($.push({_type:`separator`,label:l(e.created_at_iso),key:t}),je=t),$.push(e)});function Me(e){return/\.(jpg|jpeg|png|gif|webp|bmp)$/i.test(e||``)}let Ne=!g?.is_announcement_only||t?.role===`MD`||t?.role===`HR`;return(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`style`,{children:`
