import{c as e,f as t,i as n,m as r,p as i}from"./index-DGWqTciu.js";var a=r(t(),1),o=i(),s=()=>{let{showToast:t}=n(),[r,i]=(0,a.useState)([]),[s,c]=(0,a.useState)([]),[l,u]=(0,a.useState)(!0),[d,f]=(0,a.useState)(``),[p,m]=(0,a.useState)(``),[h,g]=(0,a.useState)(`Pending`),[_,v]=(0,a.useState)(``),[y,b]=(0,a.useState)(``),[x,S]=(0,a.useState)(`0`),[C,w]=(0,a.useState)(`18`),[T,E]=(0,a.useState)(``),[D,O]=(0,a.useState)([{service:``,amount:``,discount_percent:`0`}]),[k,A]=(0,a.useState)(!1),j=async()=>{u(!0);try{let t=await e.get(`/api/invoicing-resources/`);i(t.data.clients||[]),c(t.data.services||[])}catch(e){console.error(`Error loading invoicing resources:`,e)}finally{u(!1)}};(0,a.useEffect)(()=>{j()},[]);let M=()=>{O([...D,{service:``,amount:``,discount_percent:`0`}])},N=e=>{let t=[...D];t.splice(e,1),O(t)},P=(e,t,n)=>{let r=[...D];if(r[e][t]=n,t===`service`){let t=s.find(e=>e.id===Number(n));t&&(r[e].amount=t.amount)}O(r)},F=async n=>{if(!d){t(`Please choose a client.`,`warning`);return}let r=D.filter(e=>e.service!==``);if(r.length===0){t(`Please add at least one valid service item.`,`warning`);return}if(n===`preview`){t(`Generating preview calculations. Verify Grand Total in table below.`,`info`);return}A(!0);try{let i={client:d,project:p,discount_percent:x,gst_percent:C,note:T,status:n===`draft`?`Pending`:h,due_date:_||null,paid_date:y||null,items:r};await e.post(`/api/invoices/`,i),t(n===`draft`?`Invoice draft saved successfully.`:`Invoice generated successfully.`,`success`),n===`pdf`&&window.print(),f(``),m(``),g(`Pending`),v(``),b(``),S(`0`),w(`18`),E(``),O([{service:``,amount:``,discount_percent:`0`}])}catch(e){t(e.response?.data?.detail||`Failed to process invoice.`,`error`)}finally{A(!1)}};return(0,o.jsxs)(`div`,{className:`attendance-workspace-container`,style:{padding:`20px`,background:`#f8fafc`,minHeight:`100vh`},children:[(0,o.jsx)(`style`,{children:`
        .premium-card {
          background: #ffffff;
          border-radius: 16px;
