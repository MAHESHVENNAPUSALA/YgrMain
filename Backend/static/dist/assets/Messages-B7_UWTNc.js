import{a as e,d as t,f as n,n as r,r as i,u as a}from"./index-OYoV3RNy.js";var o=n(a(),1),s=t();function c(e=``){return e.split(` `).slice(0,2).map(e=>e[0]).join(``).toUpperCase()||`?`}function l(e){if(!e)return``;try{let t=new Date(e),n=new Date,r=new Date(n);return r.setDate(n.getDate()-1),t.toDateString()===n.toDateString()?`Today`:t.toDateString()===r.toDateString()?`Yesterday`:t.toLocaleDateString(`en-IN`,{day:`2-digit`,month:`short`,year:`numeric`})}catch{return``}}function ee(e){if(!e)return``;try{return new Date(e).toDateString()}catch{return``}}var u=[`👍`,`❤️`,`😂`,`😮`,`😢`,`🔥`,`🎉`,`👏`,`💯`,`🙏`];function d({user:e,size:t=36,style:n={}}){let[r,i]=(0,o.useState)(!1),a=e?.name||e?.username||e?.sender_name||``,l=e?.profile_pic||e?.sender_avatar;return l&&!r?(0,s.jsx)(`img`,{src:l,alt:a,onError:()=>i(!0),style:{width:t,height:t,borderRadius:`50%`,objectFit:`cover`,flexShrink:0,...n}}):(0,s.jsx)(`div`,{style:{width:t,height:t,borderRadius:`50%`,background:`linear-gradient(135deg, #3b82f6, #1d4ed8)`,color:`#fff`,display:`flex`,alignItems:`center`,justifyContent:`center`,fontWeight:700,fontSize:t*.38,flexShrink:0,...n},children:c(a)})}function f({status:e}){let t={Online:`#22c55e`,Away:`#f59e0b`,Busy:`#ef4444`,"In Meeting":`#8b5cf6`,"Working From Home":`#06b6d4`,Offline:`#94a3b8`};return(0,s.jsx)(`span`,{style:{display:`inline-block`,width:9,height:9,borderRadius:`50%`,background:t[e]||t.Offline,border:`2px solid #fff`,flexShrink:0},title:e})}var p=()=>{let{user:t}=i(),{showToast:n}=r(),[a,c]=(0,o.useState)([]),[p,m]=(0,o.useState)([]),[te,ne]=(0,o.useState)([]),[h,re]=(0,o.useState)(``),[g,_]=(0,o.useState)(null),[v,ie]=(0,o.useState)(()=>{try{return JSON.parse(localStorage.getItem(`chat_last_read`)||`{}`)}catch{return{}}}),ae=(0,o.useRef)(v),[y,b]=(0,o.useState)([]),[oe,se]=(0,o.useState)(!1),[ce,le]=(0,o.useState)(!0),[x,S]=(0,o.useState)(``),[C,w]=(0,o.useState)(null),[T,E]=(0,o.useState)(null),[D,O]=(0,o.useState)(``),[k,A]=(0,o.useState)(null),[j,M]=(0,o.useState)(null),[ue,de]=(0,o.useState)(!1),[fe,N]=(0,o.useState)(!1),[pe,me]=(0,o.useState)(``),[he,ge]=(0,o.useState)(``),[_e,P]=(0,o.useState)([]),[F,I]=(0,o.useState)(null),[L,ve]=(0,o.useState)([]),[ye,R]=(0,o.useState)(null),[be,xe]=(0,o.useState)(!1),[z,B]=(0,o.useState)(null),Se=(0,o.useRef)(null),V=(0,o.useRef)(null),H=(0,o.useRef)(null),U=(0,o.useRef)(0),Ce=(0,o.useRef)(null),W=(0,o.useRef)(null);(0,o.useEffect)(()=>{ae.current=v,localStorage.setItem(`chat_last_read`,JSON.stringify(v))},[v]);let G=(0,o.useCallback)(async()=>{try{let[t,n]=await Promise.all([e.getAllUsers(),e.getAllChatRooms(ae.current)]),r=t.data||[];c(r);let i=n.data?.channels||[],a=n.data?.teams||[];m(i),ne(a);let o=r.reduce((e,t)=>e+(t.unread||0),0),s=[...i,...a].reduce((e,t)=>e+(t.unread||0),0);window.dispatchEvent(new CustomEvent(`msg-unread-update`,{detail:o+s}))}catch(e){console.error(`Sidebar load error`,e)}finally{le(!1)}},[]),we=async t=>{if(Z){B({type:t,user:Z,status:`Calling...`});try{await e.initiateCall({receiver:Z.id,call_type:t}),setTimeout(()=>{B(e=>e?{...e,status:`Connected`}:null)},2500)}catch(e){n(e.response?.data?.detail||`Failed to initiate call session.`,`error`),B(null)}}};(0,o.useEffect)(()=>{G(),e.updatePresence({status:`Online`}).catch(()=>{});let t=setInterval(()=>G(),1e4);return()=>{clearInterval(t),e.updatePresence({status:`Offline`}).catch(()=>{})}},[G]);let K=(0,o.useCallback)(async(t=!1)=>{if(g){t&&(se(!0),U.current=0);try{let n=t?{}:{last_id:U.current};g.type===`dm`?n.user_id=g.id:n.room_id=g.id;let r=(await e.getChatHistory(n)).data?.messages||[];t?b(r):r.length>0&&b(e=>{let t=new Set(e.map(e=>e.id)),n=r.filter(e=>!t.has(e.id));return n.length?[...e,...n]:e}),r.length>0&&(U.current=r[r.length-1].id)}catch(e){console.error(`Load messages error`,e)}finally{t&&se(!1)}}},[g]);(0,o.useEffect)(()=>{if(g)return K(!0),clearInterval(H.current),H.current=setInterval(()=>K(!1),3e3),()=>clearInterval(H.current)},[g,K]),(0,o.useEffect)(()=>{Se.current?.scrollIntoView({behavior:`smooth`})},[y]),(0,o.useEffect)(()=>{let e=()=>A(null);return window.addEventListener(`click`,e),()=>window.removeEventListener(`click`,e)},[]);let Te=async t=>{t?.preventDefault();let r=x.trim();if(!r&&!V.current?.files[0]||!g)return;let i=new FormData;i.append(`text`,r),g.type===`dm`?i.append(`receiver_id`,g.id):i.append(`room_id`,g.id),C&&i.append(`reply_to_id`,C.id);let a=V.current;a?.files[0]&&(i.append(`file`,a.files[0]),a.value=``),S(``),w(null);try{let t=(await e.sendMessage(i)).data;b(e=>new Set(e.map(e=>e.id)).has(t.id)?e:[...e,t]),U.current=t.id}catch(e){n(e?.response?.data?.detail||`Failed to send message.`,`error`)}},Ee=async()=>{if(!(!T||!D.trim())){try{await e.editMessage({message_id:T.id,is_group:T.is_group,text:D}),b(e=>e.map(e=>e.id===T.id?{...e,text:D,edited:!0}:e))}catch(e){n(e?.response?.data?.detail||`Edit failed.`,`error`)}E(null),O(``)}},q=async(t,r)=>{try{await e.deleteMessage({message_id:t.id,is_group:t.is_group,mode:r}),b(r===`everyone`?e=>e.map(e=>e.id===t.id?{...e,is_deleted:!0,text:``,file_url:null}:e):e=>e.filter(e=>e.id!==t.id))}catch(e){n(e?.response?.data?.detail||`Delete failed.`,`error`)}A(null)},J=async(t,n)=>{try{let r=await e.toggleReaction({message_id:t.id,is_group:t.is_group,emoji:n});b(e=>e.map(e=>e.id===t.id?{...e,reactions:r.data.reactions}:e))}catch(e){console.error(e)}M(null)},De=async()=>{if(!(!F||!L.length)){try{await e.forwardMessage({msg_ids:[F.id],receiver_ids:L}),n(`Message forwarded.`,`success`)}catch{n(`Forward failed.`,`error`)}I(null),ve([])}},Oe=async t=>{t.preventDefault();try{await e.createTeam({name:pe,description:he,users:_e}),N(!1),me(``),ge(``),P([]),G()}catch(e){n(e?.response?.data?.detail||`Failed to create team.`,`error`)}},ke=e=>{S(e.target.value);let t=e.target;t.style.height=`auto`,t.style.height=Math.min(t.scrollHeight,140)+`px`,be||xe(!0),clearTimeout(Ce.current),Ce.current=setTimeout(()=>xe(!1),2e3)},Ae=a.filter(e=>e.name.toLowerCase().includes(h.toLowerCase())||e.role.toLowerCase().includes(h.toLowerCase())),Y=p.filter(e=>e.name.toLowerCase().includes(h.toLowerCase())),X=te.filter(e=>e.name.toLowerCase().includes(h.toLowerCase())),Z=g?.type===`dm`?a.find(e=>e.id===g.id):null,Q=g?.name||``,$=[],je=``;y.forEach(e=>{let t=ee(e.created_at_iso);t&&t!==je&&($.push({_type:`separator`,label:l(e.created_at_iso),key:t}),je=t),$.push(e)});function Me(e){return/\.(jpg|jpeg|png|gif|webp|bmp)$/i.test(e||``)}let Ne=!g?.is_announcement_only||t?.role===`MD`||t?.role===`HR`;return(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`style`,{children:`
