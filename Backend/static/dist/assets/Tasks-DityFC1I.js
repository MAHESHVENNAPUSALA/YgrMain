import{c as e,d as t,f as n,n as ee,o as r,r as i,u as a}from"./index-OYoV3RNy.js";var o=n(a(),1),s=t(),c=()=>{let{user:t}=i(),{showToast:n}=ee(),a=t?.role,c=e().state,[l,u]=(0,o.useState)(c?.activeTab||`board`),[d,f]=(0,o.useState)([]),[p,te]=(0,o.useState)([]),[m,h]=(0,o.useState)([]),[ne,g]=(0,o.useState)(!0),[_,re]=(0,o.useState)(c?.statusFilter||``),[v,ie]=(0,o.useState)(c?.projectFilter||``);(0,o.useEffect)(()=>{c&&(c.activeTab&&u(c.activeTab),c.statusFilter&&re(c.statusFilter),c.projectFilter&&ie(c.projectFilter))},[c]);let[y,b]=(0,o.useState)(``),[x,S]=(0,o.useState)(``),[C,w]=(0,o.useState)(``),[T,E]=(0,o.useState)(``),[D,O]=(0,o.useState)(``),[k,A]=(0,o.useState)([]),[j,M]=(0,o.useState)([]),[N,P]=(0,o.useState)(!1),[F,I]=(0,o.useState)(``),[L,R]=(0,o.useState)(``),[z,B]=(0,o.useState)(``),[V,H]=(0,o.useState)(``),[U,W]=(0,o.useState)(``),[G,K]=(0,o.useState)(!1),[q,J]=(0,o.useState)(null),[Y,ae]=(0,o.useState)(``),[X,oe]=(0,o.useState)(null),Z=async()=>{g(!0);try{if(f((await r.get(`/api/tasks/`)).data),te((await r.get(`/api/projects/`)).data),h((await r.get(`/api/daily-reports/`)).data),[`TeamLead`,`Manager`,`HR`,`MD`].includes(a)){let e={};[`TeamLead`,`Manager`].includes(a)&&(e.scope=`team`),M((await r.get(`/api/users/`,{params:e})).data||[])}}catch(e){console.error(`Error loading task management data:`,e)}finally{g(!1)}};(0,o.useEffect)(()=>{Z()},[]);let se=async e=>{e.preventDefault(),P(!0);try{await r.post(`/api/tasks/`,{task_name:y,description:x,project:C,start_date:T,end_date:D,members:k}),n(`Task assigned successfully.`,`success`),b(``),S(``),w(``),E(``),O(``),A([]),u(`board`),Z()}catch(e){n(e.response?.data?.detail||`Failed to assign task.`,`error`)}finally{P(!1)}},ce=async e=>{e.preventDefault(),K(!0);try{await r.post(`/api/daily-reports/`,{project:F,tasks_completed:L,tasks_in_progress:z,issues:V,plan_for_tomorrow:U}),n(`Daily report submitted.`,`success`),I(``),R(``),B(``),H(``),W(``),Z()}catch(e){n(e.response?.data?.detail||`Failed to submit report.`,`error`)}finally{K(!1)}},le=async e=>{e.preventDefault();try{let e=new FormData;e.append(`status`,`Submitted`),e.append(`remarks`,Y),X&&e.append(`file`,X),await r.put(`/api/tasks/${q.id}/`,e,{headers:{"Content-Type":`multipart/form-data`}}),n(`Task submitted successfully.`,`success`),J(null),Z()}catch(e){n(e.response?.data?.detail||`Failed to submit task.`,`error`)}},Q=async(e,t)=>{try{await r.post(`/api/tasks/${e}/review/`,{action:t,score:100,remarks:`Reviewed from task board.`}),n(`Task ${t===`submit_to_manager`?`approved`:`returned`}.`,`success`),Z()}catch(e){n(e.response?.data?.detail||`Failed to process task review.`,`error`)}},$=d.filter(e=>!(v===`active`&&e.project&&e.project.status!==`Active`||_&&e.status!==_));return(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`style`,{children:`
        .task-tabs {
          display: flex;
          gap: 10px;
