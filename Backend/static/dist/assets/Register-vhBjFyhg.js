import{c as e,d as t,f as n,l as r,n as i,o as a,r as o,u as s}from"./index-OYoV3RNy.js";var c=n(s(),1),l=t(),u=()=>{let{user:t}=o(),{showToast:n}=i();r();let s=e(),u=t?.role,d=s.state?.defaultRole||`Employee`,[f,p]=(0,c.useState)(``),[m,h]=(0,c.useState)(``),[g,_]=(0,c.useState)(``),[v,y]=(0,c.useState)(``),[b,x]=(0,c.useState)(``),[S,C]=(0,c.useState)(`Male`),[w,T]=(0,c.useState)(``),[E,D]=(0,c.useState)(``),[O,k]=(0,c.useState)(`Fresher`),[A,j]=(0,c.useState)(``),[M,N]=(0,c.useState)(``),[P,F]=(0,c.useState)(``),[I,L]=(0,c.useState)(``),[R,z]=(0,c.useState)(``),[B,V]=(0,c.useState)(``),[H,U]=(0,c.useState)(d),[W,G]=(0,c.useState)(null),[K,q]=(0,c.useState)(null),[J,Y]=(0,c.useState)(!1);return u!==`HR`&&u!==`MD`&&u!==`Manager`?(0,l.jsx)(`div`,{style:{color:`var(--danger)`,fontWeight:700,padding:`20px`},children:`Access Denied: Only HR, MD or Manager can access registration page.`}):(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`style`,{children:`
        .register-grid {
          display: grid;
