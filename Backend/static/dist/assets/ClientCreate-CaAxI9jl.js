import{c as e,f as t,i as n,m as r,p as i}from"./index-DGWqTciu.js";var a=r(t(),1),o=i(),s=()=>{let{showToast:t}=n(),[r,i]=(0,a.useState)(``),[s,c]=(0,a.useState)(``),[l,u]=(0,a.useState)(``),[d,f]=(0,a.useState)(``),[p,m]=(0,a.useState)(``),[h,g]=(0,a.useState)(``),[_,v]=(0,a.useState)(`India`),[y,b]=(0,a.useState)(``),[x,S]=(0,a.useState)(``),[C,w]=(0,a.useState)(``),[T,E]=(0,a.useState)(``),[D,O]=(0,a.useState)(`Active`),[k,A]=(0,a.useState)(!1),j=async n=>{n.preventDefault(),A(!0);try{await e.post(`/api/clients/`,{name:r,business_name:s,gst_number:l,email:d,phone:p,address:h,country:_,state:y,city:x,contact_person:C,website:T,status:D}),t(`Client registered successfully.`,`success`),M()}catch(e){t(e.response?.data?.detail||`Failed to save client profile.`,`error`)}finally{A(!1)}},M=()=>{i(``),c(``),u(``),f(``),m(``),g(``),v(`India`),b(``),S(``),w(``),E(``),O(`Active`)};return(0,o.jsxs)(`div`,{className:`attendance-workspace-container`,style:{padding:`20px`,background:`#f8fafc`,minHeight:`100vh`},children:[(0,o.jsx)(`style`,{children:`
        .premium-card {
          background: #ffffff;
          border-radius: 16px;
