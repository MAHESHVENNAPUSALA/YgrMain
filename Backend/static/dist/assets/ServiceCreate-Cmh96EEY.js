import{d as e,f as t,n,o as r,t as i,u as a}from"./index-OYoV3RNy.js";var o=t(a(),1),s=e(),c=()=>{let{showToast:e}=n(),{confirm:t}=i(),[a,c]=(0,o.useState)([]),[l,u]=(0,o.useState)(!0),[d,f]=(0,o.useState)(``),[p,m]=(0,o.useState)(``),[h,g]=(0,o.useState)(``),[_,v]=(0,o.useState)(``),[y,b]=(0,o.useState)(`18`),[x,S]=(0,o.useState)(``),[C,w]=(0,o.useState)(`Active`),[T,E]=(0,o.useState)(null),[D,O]=(0,o.useState)(!1),k=async()=>{u(!0);try{c((await r.get(`/api/services/`)).data)}catch(e){console.error(`Error loading services:`,e)}finally{u(!1)}};(0,o.useEffect)(()=>{k()},[]);let A=async t=>{t.preventDefault(),O(!0);let n={name:d,service_code:p,department:h,description:_,gst_percent:parseFloat(y),amount:parseFloat(x),status:C};try{T?(await r.put(`/api/services/${T}/`,n),e(`Service updated successfully.`,`success`)):(await r.post(`/api/services/`,n),e(`Service registered successfully.`,`success`)),N(),k()}catch(t){e(t.response?.data?.detail||`Failed to save service.`,`error`)}finally{O(!1)}},j=e=>{E(e.id),f(e.name||``),m(e.service_code||``),g(e.department||``),v(e.description||``),b(String(e.gst_percent||`18`)),S(String(e.amount||``)),w(e.status||`Active`)},M=async n=>{if(await t(`Are you sure you want to delete this service?`))try{await r.delete(`/api/services/${n}/`),e(`Service deleted successfully.`,`success`),k()}catch{e(`Failed to delete service.`,`error`)}},N=()=>{E(null),f(``),m(``),g(``),v(``),b(`18`),S(``),w(`Active`)};return(0,s.jsxs)(`div`,{className:`attendance-workspace-container`,style:{display:`grid`,gridTemplateColumns:`1.2fr 1fr`,gap:`24px`,alignItems:`start`,padding:`20px`,background:`#f8fafc`,minHeight:`100vh`},children:[(0,s.jsx)(`style`,{children:`
        .premium-card {
          background: #ffffff;
          border-radius: 16px;
