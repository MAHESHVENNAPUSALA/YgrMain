import{d as e,f as t,l as n,n as r,o as i,r as a,t as o,u as s}from"./index-OYoV3RNy.js";import"./OnLeaveTodayWidget-C2_sBF-y.js";var c=t(s(),1),l=e(),u=()=>{let{user:e}=a(),t=n(),{showToast:s}=r(),{prompt:u}=o(),[f,p]=(0,c.useState)(null),[m,h]=(0,c.useState)(!0),[g,_]=(0,c.useState)(``),[v,y]=(0,c.useState)(null),[b,x]=(0,c.useState)(``),[S,C]=(0,c.useState)(``);(0,c.useEffect)(()=>{(async()=>{try{p((await i.get(`/api/dashboard/md/`)).data)}catch(e){console.error(`Error fetching MD dashboard metrics:`,e)}finally{h(!1)}})();let e=setInterval(()=>{_(new Date().toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`,second:`2-digit`}))},1e3);return()=>clearInterval(e)},[]);let[w,T]=(0,c.useState)([]),E=async(e,t)=>{let n=await u(`Enter remarks for ${t}ing this attendance correction request:`)||``;if(n!==null)try{await i.post(`/api/attendance/corrections/bulk-action/`,{action:t,correction_ids:[e],md_remarks:n}),s(`Attendance correction has been ${t}ed.`,`success`),p((await i.get(`/api/dashboard/md/`)).data)}catch(e){s(e.response?.data?.detail||`Failed to update correction request.`,`error`)}},D=async e=>{if(w.length===0){s(`Please select at least one correction request.`,`warning`);return}let t=await u(`Enter remarks for ${e}ing the selected correction requests:`)||``;if(t!==null)try{await i.post(`/api/attendance/corrections/bulk-action/`,{action:e,correction_ids:w,md_remarks:t}),s(`Selected corrections have been ${e}ed.`,`success`),T([]),p((await i.get(`/api/dashboard/md/`)).data)}catch(e){s(e.response?.data?.detail||`Failed to update correction requests.`,`error`)}},O=async(e,t)=>{let n=``;if(t===`reject`){if(n=await u(`Please enter comments/reason for rejection:`)||``,n===null)return}else if(n=await u(`Enter any comments (optional):`)||``,n===null)return;try{await i.post(`/api/leaves/${e}/action/`,{action:t,comments:n}),s(`Leave request ${t}ed successfully.`,`success`),p((await i.get(`/api/dashboard/md/`)).data)}catch(e){s(e.response?.data?.detail||`Failed to update leave request.`,`error`)}};if(m)return(0,l.jsxs)(`div`,{style:{display:`flex`,justifyContent:`center`,alignItems:`center`,minHeight:`450px`,color:`var(--muted)`},children:[(0,l.jsx)(`i`,{className:`fa-solid fa-spinner fa-spin`,style:{fontSize:`2rem`,marginRight:`10px`}}),` Loading Executive Dashboard...`]});let k=f?.total_cmp||0,A=f?.total_project||0;f?.total_mr,f?.total_tl,f?.total_emp;let j=f?.present_count||0,M=f?.on_leave_count||0;f?.late_count;let N={development:f?.dept_counts?.development||0,design:f?.dept_counts?.design||0,hr:f?.dept_counts?.hr||0,marketing:f?.dept_counts?.marketing||0,sales:f?.dept_counts?.sales||0},P={development:f?.dept_attendance?.development||0,design:f?.dept_attendance?.design||0,hr:f?.dept_attendance?.hr||0,marketing:f?.dept_attendance?.marketing||0,sales:f?.dept_attendance?.sales||0};return(0,l.jsxs)(`div`,{className:`executive-dashboard-container`,children:[(0,l.jsx)(`style`,{children:`
