import{d as e,f as t,i as n,l as r,n as i,r as a,s as o,u as s}from"./index-AkGv6LCI.js";var c=t(e(),1),l=n(),u=()=>{let{user:e}=a(),{showToast:t}=i();s();let n=r(),u=e?.role,d=n.state?.defaultRole||`Employee`,[f,p]=(0,c.useState)(``),[m,h]=(0,c.useState)(``),[g,_]=(0,c.useState)(``),[v,y]=(0,c.useState)(``),[b,x]=(0,c.useState)(``),[S,C]=(0,c.useState)(`Male`),[w,T]=(0,c.useState)(``),[E,D]=(0,c.useState)(``),[O,k]=(0,c.useState)(`Fresher`),[A,j]=(0,c.useState)(``),[M,N]=(0,c.useState)(``),[P,F]=(0,c.useState)(``),[I,L]=(0,c.useState)(``),[R,z]=(0,c.useState)(``),[B,V]=(0,c.useState)(``),[H,U]=(0,c.useState)(d),[W,G]=(0,c.useState)(null),[K,q]=(0,c.useState)(null),[J,Y]=(0,c.useState)(!1);return u!==`HR`&&u!==`MD`&&u!==`Manager`?(0,l.jsx)(`div`,{style:{color:`var(--danger)`,fontWeight:700,padding:`20px`},children:`Access Denied: Only HR, MD or Manager can access registration page.`}):(0,l.jsxs)(`div`,{children:[(0,l.jsx)(`style`,{children:`
        .register-grid {
          display: grid;
