import{d as e,f as t,i as n,n as r,r as i,s as a}from"./index-ComLrwa0.js";var o=t(e(),1),s=n(),c=()=>{let{user:e}=i(),{showToast:t}=r(),n=e?.role,[c,l]=(0,o.useState)(``),[u,d]=(0,o.useState)(``),[f,p]=(0,o.useState)(``),[m,h]=(0,o.useState)(``),[g,_]=(0,o.useState)(``),[v,y]=(0,o.useState)(`Male`),[b,x]=(0,o.useState)(``),[S,C]=(0,o.useState)(``),[w,T]=(0,o.useState)(`Fresher`),[E,D]=(0,o.useState)(``),[O,k]=(0,o.useState)(``),[A,j]=(0,o.useState)(``),[M,N]=(0,o.useState)(``),[P,F]=(0,o.useState)(``),[I,L]=(0,o.useState)(``),[R,z]=(0,o.useState)(`Employee`),[B,V]=(0,o.useState)(null),[H,U]=(0,o.useState)(null),[W,G]=(0,o.useState)(!1);return n!==`HR`&&n!==`MD`?(0,s.jsx)(`div`,{style:{color:`var(--danger)`,fontWeight:700,padding:`20px`},children:`Access Denied: Only HR or MD can access registration page.`}):(0,s.jsxs)(`div`,{children:[(0,s.jsx)(`style`,{children:`
        .register-grid {
          display: grid;
