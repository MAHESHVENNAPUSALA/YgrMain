...
@media (max-width: 600px) {
    ...
    /* Container and cards adjustments */
    .container {
        flex-direction: column;
        gap: 20px;
        padding: 20px;
...
<div class="header">
<div class="left">
<img alt="logohello" src="/image/logo-1-removebg-preview.png"/>
</div>
<h2>Register</h2>
<div class="right">
<a href="#">Home</a>
...
<div class="card">
<h2>Apply for intenship</h2>
<a href=""><button type="button">View Internship</button></a>
<div class="already-registered" style="text-align:center; margin-top:15px; font-size: 15px;">
        Already registered? <a href="">Login</a>
</div>
</div>
...
export default OriginalExampagesHome;
