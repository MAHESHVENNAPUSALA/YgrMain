...
const OriginalExampagesVacancies = () => {
...
<!-- Jobs Grid -->
<div class="jobs-grid">
<div class="job-card-modern reveal">
<h2></h2>
...
<div class="gold-btn-outline w-100 mb-3" onclick="openJobModal('', '', '')">
                    View Requirements
                </div>
<a class="gold-btn w-100 mt-auto" href="">
                    Apply for Position
                </a>
</div>
<div class="empty-state reveal">
<i class="fas fa-search" style="font-size: 48px; color: #ccc; margin-bottom: 20px; display: block;"></i>
<h2>No Active Vacancies</h2>
<p>We're not hiring for any specific roles right now, but we're always looking for talent. Check back soon!</p>
</div>
</div>
</div>
 Job Detail Modal 
...
export default OriginalExampagesVacancies;
